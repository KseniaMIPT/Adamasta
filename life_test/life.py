...
#canvas.itemconfig(cell_matrix[int(addr(8, 8))], state=NORMAL, tags='vis')
#canvas.itemconfig(cell_matrix[int(addr(10, 9))], state=NORMAL, tags='vis')
#canvas.itemconfig(cell_matrix[int(addr(9, 9))], state=NORMAL, tags='vis')
#canvas.itemconfig(cell_matrix[int(addr(9, 8))], state=NORMAL, tags='vis')
#canvas.itemconfig(cell_matrix[int(addr(9, 7))], state=NORMAL, tags='vis')
#canvas.itemconfig(cell_matrix[int(addr(10, 7))], state=NORMAL, tags='vis')
canvas.itemconfig(cell_matrix[int(addr(10, 7))], state=NORMAL, tags='vis')
canvas.itemconfig(cell_matrix[int(addr(10, 6))], state=NORMAL, tags='vis')
canvas.itemconfig(cell_matrix[int(addr(10, 5))], state=NORMAL, tags='vis')
